<div class="ui mini icon right floated load-model button" style="background-color: #ffff0a ; color: #000"
    ...
    data-title="<img src='{{ asset('assets/images/app_logo.png') }}' height='25px' /> <span style='vertical-align: super;color:#000'>&nbsp;Nouveau commande</span>"
    data-color="#ffff0a none repeat scroll 0% 0%" data-width="1024"><i class="add icon"></i>&nbsp;Nouveau
    commande</div>
<br>
<br>
